...
function cekk(xvalue){
	var nofok="<?php echo $nofak;?>";
	var id_supplier = xvalue;
	var nofak = $('#nofak').val();
	var optradio =  $('input[name=optradio]:checked').val();
	if(!optradio){
 ...
 <div class="col-xs-12">
    ...
    <label class="radio-inline">
      <input type="radio" name="optradio" onclick="pokus()" id="optradio" value="gudang">Gudang
               ...
               <td>Kode Barang</td>
                  <td><input type="text" onchange="cekk(this.value)" onclick="clickedEdFind()" class="form-control col-xs-3" name="id_supplier" id="id_supplier" /></td>
